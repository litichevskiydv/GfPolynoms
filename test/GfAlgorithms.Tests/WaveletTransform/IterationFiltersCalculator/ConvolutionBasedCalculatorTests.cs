namespace AppliedAlgebra.GfAlgorithms.Tests.WaveletTransform.IterationFiltersCalculator
{
    ...
    {
        private readonly ConvolutionBasedCalculator _iterationFiltersCalculator;
        ...
        public ConvolutionBasedCalculatorTests()
        {
            _iterationFiltersCalculator = new ConvolutionBasedCalculator();
        }
