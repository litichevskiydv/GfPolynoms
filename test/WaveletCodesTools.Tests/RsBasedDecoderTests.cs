            ...
            DecoderTestsData = new[]
                               {
                                   ...
                                   PrepareDataWithErrors(8, 4, 4, generationPolynomial2, encoder, new Polynomial(gf9, 0, 0, 3), 1),
                                   PrepareDataWithErrors(8, 4, 4, generationPolynomial2, encoder, new Polynomial(gf9, 1, 2, 3, 4), 1),
                                   PrepareDataWithErrors(8, 4, 4, generationPolynomial2, encoder, new Polynomial(gf9, 1, 2), 1),
                                   PrepareDataWithErrors(8, 4, 4, generationPolynomial2, encoder, new Polynomial(gf9, 0, 0, 0, 6), 1),
                                   PrepareDataWithErrors(10, 5, 6, generationPolynomial3, encoder, new Polynomial(gf11, 1, 2, 3, 4, 5), 2),
                                   PrepareDataWithErrors(10, 5, 5, generationPolynomial4, encoder, new Polynomial(gf11, 1, 2, 3, 4, 5), 2),
                                   PrepareDataWithErrors(12, 6, 6, generationPolynomial5, encoder, new Polynomial(gf13, 1, 2, 3, 4, 5, 6), 2),
                                   PrepareDataWithErrors(12, 6, 6, generationPolynomial5, encoder, new Polynomial(gf13, 0, 2, 0, 2, 11), 2),
                                   PrepareDataWithErrors(26, 13, 12, generationPolynomial6, encoder, new Polynomial(gf27, 0, 2, 0, 2, 11), 5),
                                   PrepareDataWithoutErrors(26, 13, 12, generationPolynomial6, encoder, new Polynomial(gf27, 0, 2, 0, 2, 11), 5)
                               };
        }
