namespace GfPolynoms.Tests
{
    ...
    public class PolynomialUnderPrimeOrderFieldTest
    {
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] { 0, 1, 1, 0 });
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] { 0, 0, 0, 0 });
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] {1, 1});
            var b = new Polynomial(_field, new[] {0, 1, 1});

            // When
            var c = a + b;

            // Then
            Assert.AreEqual(new Polynomial(_field, new[] {1, 0, 1}), c);
        }
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] { 1, 1, 1 });
            var b = new Polynomial(_field, new[] { 1, 0, 1 });

            // When
            var c = a + b;

            // Then
            Assert.AreEqual(new Polynomial(_field, new[] { 0, 1 }), c);
        }
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] { 0, 1, 1 });
            var b = new Polynomial(_field, new[] { 1, 0, 1 });
            ...
            // Then
            Assert.AreEqual(new Polynomial(_field, new[] { 1, 1 }), c);
        }
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] { 0, 0, 1 });
            var b = new Polynomial(_field, new[] { 1, 1 });

            // When
            var c = a - b;

            // Then
            Assert.AreEqual(new Polynomial(_field, new[] { 1, 1, 1 }), c);
        }
        ...
        public void ShouldSubtractTwoPolynoms3()
        {
            ...
            // Then
            Assert.AreEqual(new Polynomial(_field, new[] { 0 }), c);
        }
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] { 0, 1 });
            var b = new Polynomial(_field, new[] { 1, 1 });
            ...
            // Then
            Assert.AreEqual(new Polynomial(_field, new[] { 0, 1, 1 }), c);
        }
        ...
        public void ShouldMultiplyTwoPolynoms3()
        {
            ...
            // Then
            Assert.AreEqual(new Polynomial(_field, new[] {0, 1, 0, 1}), c);
        }
        ...
        public void ShouldPerformRightShift()
        {
            ...
            // Then
            Assert.AreEqual(new Polynomial(_field, new[] { 0, 0, 1, 1 }), c);
        }
        ...
        public void ShouldPerformEnlarge()
        {
            ...
            // Then
            Assert.AreEqual(new Polynomial(_field, new[] { 0, 0, 0, 0, 1 }), c);
        }
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] {1});
            var b = new Polynomial(_field, new[] {1, 1, 0, 1});
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] {1}).RightShift(1);
            var b = new Polynomial(_field, new[] { 1, 1, 0, 1 });
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] { 1 }).RightShift(3);
            var b = new Polynomial(_field, new[] { 1, 1, 0, 1 });
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] { 1 }).RightShift(4);
            var b = new Polynomial(_field, new[] { 1, 1, 0, 1 });
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] { 1 }).RightShift(5);
            var b = new Polynomial(_field, new[] { 1, 1, 0, 1 });
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] { 1 }).RightShift(6);
            var b = new Polynomial(_field, new[] { 1, 1, 0, 1 });
        ...
        {
            // Given
            var a = new Polynomial(_field, new[] { 1 }).RightShift(7);
            var b = new Polynomial(_field, new[] { 1, 1, 0, 1 });
